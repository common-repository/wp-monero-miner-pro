...
include_once('MoneroMinerPro_InstallIndicator.php');

class MoneroMinerPro_LifeCycle extends MoneroMinerPro_InstallIndicator {
    ...
    public function activate() {
        ...
        add_action( 'admin_notices', array( $this, 'activate_msg' ) ) ;
        set_transient( 'fx-admin-notice-example', true, 5 );


    }

    public function activate_msg() {
        ...
        if( get_transient( 'fx-admin-notice-example' ) ) {
            ...
            <div class="updated">
                <p>
                    Now enter your monero wallet and enable miner on <b>Monero Miner Pro</b> <a
                        href="?page=MoneroMinerPro_PluginSettings">settings page</a>.
                </p>
            </div>
